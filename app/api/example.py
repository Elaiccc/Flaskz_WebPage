...
from ..modules.example import DepartmentModel, EmployeeModel, SimpleModel, DepartmentDeviceModel
...
register_model_route(api_bp, DepartmentDeviceModel, 'ex-department-devices', 'ex-department-devices')
